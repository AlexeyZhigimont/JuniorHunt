...
function openTab(e, t) {
    var n, i, o;
    for (i = document.getElementsByClassName("tab-content"), n = 0; n < i.length; n++) i[n].style.display = "none";
    for (o = document.getElementsByClassName("tabs-link"), n = 0; n < o.length; n++) o[n].className = o[n].className.replace(" active", "");
...
!function (e, t) {
    ...
    x.fn = x.prototype = {
        ...
        expando: "jQuery" + (b + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var i, o, s = 0, a = [];
            if (T(e)) for (i = e.length; s < i; s++) null != (o = t(e[s], s, n)) && a.push(o); else for (s in e) null != (o = t(e[s], s, n)) && a.push(o);
            return r(a)
        }, guid: 1, support: f
        ...
        function (e) {
            var t, n, i, o, r, s, a, l, c, d, u, p, f, h, v, g, y, m, w, b = "sizzle" + 1 * new Date, x = e.document,
                T = 0, k = 0, S = le(), C = le(), $ = le(), A = le(), E = function (e, t) {
                    return e === t && (u = !0), 0
                }, j = {}.hasOwnProperty, D = [], N = D.pop, H = D.push, L = D.push, O = D.slice, P = function (e, t) {
                ...
                _ = new RegExp("^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*"),
                B = new RegExp("^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*"),
                U = new RegExp(M + "|>"), X = new RegExp(W), Y = new RegExp("^" + I + "$"), V = {
                    ID: new RegExp("^#(" + I + ")"),
                    CLASS: new RegExp("^\\.(" + I + ")"),
                    TAG: new RegExp("^(" + I + "|[*])"),
                    ATTR: new RegExp("^" + z),
                ...
                }, G = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/,
                Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
            ...
            try {
                L.apply(D = O.call(x.childNodes), x.childNodes), D[x.childNodes.length].nodeType
            } catch (e) {
                L = {
            ...
            function Se(e) {
                for (var t, n, o, r = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, d = be((function (e) {
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
                        ...
                        return ke(l > 1 && xe(p), l > 1 && we(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(F, "$1"), n, l < o && Se(e.slice(l, o)), o < r && Se(e = e.slice(o)), o < r && we(e))
                    }
                    p.push(n)
                }
                return xe(p)
                    ...
                    a = $(e, function (e, t) {
                        var n = t.length > 0, o = e.length > 0, r = function (r, s, a, l, d) {
                            ...
                            if (y += m, n && m !== y) {
                                ...
                                if (r) {
                                    if (y > 0) for (; m--;) w[m] || b[m] || (b[m] = N.call(l));
                                    b = Te(b)
                                }
    ...
    (x.fn.init = function (e, t, n) {
        ...
        if (n = n || D, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), E.test(i[1]) && x.isPlainObject(t)) for (i in t) h(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    }).prototype = x.fn, D = x(g);
    var H = /^(?:parents|prev(?:Until|All))/, L = {children: !0, contents: !0, next: !0, prev: !0};
    ...
    x.fn.extend({
        ...
        x.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = x.filter(i, o)), this.length > 1 && (L[e] || x.uniqueSort(o), H.test(e) && o.reverse()), this.pushStack(o)
        }
    }));
    var P = /[^\x20\t\r\n\f]+/g;
    ...
    x.Callbacks = function (e) {
        ...
        Deferred: function (t) {
                ...
                i = "pending", o = {
                    state: function () {
                            ...
                            return function () {
                                var a = this, l = arguments, c = function () {
                                    ...
                                    if (!(t < r)) {
                                        ...
                                        c = e && ("object" == typeof e || "function" == typeof e) && e.then, h(c) ? o ? c.call(e, s(r, n, q, o), s(r, n, M, o)) : (r++, c.call(e, s(r, n, q, o), s(r, n, M, o), s(r, n, q, n.notifyWith))) : (i !== q && (a = void 0, l = [e]), (o || n.resolveWith)(a, l))
                                    }
                                }, d = o ? c : function () {
                                    try {
                                        c()
                                    } catch (e) {
                                        x.Deferred.exceptionHook && x.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= r && (i !== M && (a = void 0, l = [e]), n.rejectWith(a, l))
                                    }
                                };
                        ...
                        return x.Deferred((function (e) {
                            n[0][3].add(s(0, e, h(o) ? o : q, e.notifyWith)), n[1][3].add(s(0, e, h(t) ? t : q)), n[2][3].add(s(0, e, h(i) ? i : M))
                        })).promise()
                    }, promise: function (e) {
            ...
            if (t <= 1 && (I(e, s.done(a(n)).resolve, s.reject, !t), "pending" === s.state() || h(r[n] && r[n].then))) return s.then();
            for (; n--;) I(r[n], a(n), s.reject);
            return s.promise()
        }
    });
    ...
    }), x.ready.then = W.then, "complete" === g.readyState || "loading" !== g.readyState && !g.documentElement.doScroll ? e.setTimeout(x.ready) : (g.addEventListener("DOMContentLoaded", R), e.addEventListener("load", R));
    var F = function (e, t, n, i, o, r, s) {
        var a = 0, l = e.length, c = null == n;
        if ("object" === w(n)) for (a in o = !0, n) F(e, t, a, n[a], !0, r, s); else if (void 0 !== i && (o = !0, h(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
            return c.call(x(e), n)
    ...
    function de(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++) (i = e[r]).style && (n = i.style.display, t ? ("none" === n && (o[r] = G.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && se(i) && (o[r] = ce(i))) : "none" !== n && (o[r] = "none", G.set(i, "display", n)));
    ...
    ue = g.createDocumentFragment().appendChild(g.createElement("div")), (pe = g.createElement("input")).setAttribute("type", "radio"), pe.setAttribute("checked", "checked"), pe.setAttribute("name", "t"), ue.appendChild(pe), f.checkClone = ue.cloneNode(!0).cloneNode(!0).lastChild.checked, ue.innerHTML = "<textarea>x</textarea>", f.noCloneChecked = !!ue.cloneNode(!0).lastChild.defaultValue, ue.innerHTML = "<option></option>", f.option = !!ue.lastChild;
    var ge = {
        thead: [1, "<table>", "</table>"],
    ...
    function be(e, t, n, i, o) {
        for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) if ((r = e[f]) || 0 === r) if ("object" === w(r)) x.merge(p, r.nodeType ? [r] : r); else if (we.test(r)) {
            for (s = s || u.appendChild(t.createElement("div")), a = (he.exec(r) || ["", ""])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + x.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
            x.merge(p, s.childNodes), (s = u.firstChild).textContent = ""
        } else p.push(t.createTextNode(r));
        for (u.textContent = "", f = 0; r = p[f++];) if (i && x.inArray(r, i) > -1) o && o.push(r); else if (c = oe(r), s = ye(u.appendChild(r), "script"), c && me(s), n) for (d = 0; r = s[d++];) ve.test(r.type || "") && n.push(r);
        return u
    }
    ...
    x.event = {
        global: {}, add: function (e, t, n, i, o) {
            ...
            if (Y(e)) for (n.handler && (n = (r = n).handler, o = r.selector), o && x.find.matchesSelector(ie, o), n.guid || (n.guid = x.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
                return void 0 !== x && x.event.triggered !== t.type ? x.event.dispatch.apply(e, arguments) : void 0
            }), c = (t = (t || "").match(P) || [""]).length; c--;) f = v = (a = xe.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = x.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = x.event.special[f] || {}, d = x.extend({
                type: f,
                origType: v,
                data: i,
                handler: n,
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--;) if (f = v = (a = xe.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
            ...
            load: {noBubble: !0}, click: {
                setup: function (e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && A(t, "input") && $e(t, "click", Te), !1
                }, trigger: function (e) {
                    var t = this || e;
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Te : ke, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && x.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[x.expando] = !0
    }, x.Event.prototype = {
        constructor: x.Event,
    ...
    function Pe(e, t, n, i) {
        ...
        if (p && (s = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            for (l = (a = x.map(ye(o, "script"), Ne)).length; u < p; u++) c = o, u !== v && (c = x.clone(c, !0, !0), l && x.merge(a, ye(c, "script"))), n.call(e[u], c, u);
            if (l) for (d = a[a.length - 1].ownerDocument, x.map(a, He), u = 0; u < l; u++) c = a[u], ve.test(c.type || "") && !G.access(c, "globalEval") && x.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}, d) : m(c.textContent.replace(je, ""), c, d))
        }
        return e
    }

    function qe(e, t, n) {
        for (var i, o = t ? x.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || x.cleanData(ye(i)), i.parentNode && (n && oe(i) && me(ye(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    ...
    x.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || x.isXMLDoc(e))) for (s = ye(a), i = 0, o = (r = ye(e)).length; i < o; i++) Oe(r[i], s[i]);
    ...
    function Re(e, t, n) {
        ...
        return (n = n || Ie(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = x.style(e, t)), !f.pixelBoxStyles() && Me.test(s) && We.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    var _e = ["Webkit", "Moz", "ms"], Be = g.createElement("div").style, Ue = {};

    function Xe(e) {
        var t = x.cssProps[e] || Ue[e];
        return t || (e in Be ? e : Ue[e] = function (e) {
            for (var t = e[0].toUpperCase() + e.slice(1), n = _e.length; n--;) if ((e = _e[n] + t) in Be) return e
        }(e) || e)
    }

    var Ye = /^(none|table(?!-c[ea]).+)/, Ve = /^--/,
    ...
    function Ze(e, t, n) {
        var i = Ie(e), o = (!f.boxSizingReliable() || n) && "border-box" === x.css(e, "boxSizing", !1, i), r = o,
            s = Re(e, t, i), a = "offset" + t[0].toUpperCase() + t.slice(1);
        if (Me.test(s)) {
            if (!n) return s;
            s = "auto"
        }
        return (!f.boxSizingReliable() && o || !f.reliableTrDimensions() && A(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === x.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === x.css(e, "boxSizing", !1, i), (r = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + Ke(e, t, n || (o ? "border" : "content"), r, i, s) + "px"
    }
    ...
    x.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (l || (t = Xe(a)), s = x.cssHooks[t] || x.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
        ...
        css: function (e, t, n, i) {
            var o, r, s, a = X(t);
            return Ve.test(t) || (t = Xe(a)), (s = x.cssHooks[t] || x.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Re(e, t, i)), "normal" === o && t in Qe && (o = Qe[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), x.each(["height", "width"], (function (e, t) {
        x.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !Ye.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, i) : ze(e, Ge, (function () {
                    return Ze(e, t, i)
                }))
            }, set: function (e, n, i) {
                var o, r = Ie(e), s = !f.scrollboxSize() && "absolute" === r.position,
                    a = (s || i) && "border-box" === x.css(e, "boxSizing", !1, r), l = i ? Ke(e, t, i, a, r) : 0;
                return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Ke(e, t, "border", !1, r) - .5)), l && (o = te.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = x.css(e, t)), Je(0, n, l)
            }
        }
    })), x.cssHooks.marginLeft = Fe(f.reliableMarginLeft, (function (e, t) {
        if (t) return (parseFloat(Re(e, "marginLeft")) || e.getBoundingClientRect().left - ze(e, {marginLeft: 0}, (function () {
    ...
    function ct(e, t, n) {
        ...
        for (!function (e, t) {
            var n, i, o, r, s;
            for (n in e) if (o = t[i = X(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = x.cssHooks[i]) && "expand" in s) for (n in r = s.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = o); else t[i] = o
    ...
    x.Animation = x.extend(ct, {
        tweeners: {
            ...
            if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f)) for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (d = x.css(e, "display")) && (c ? d = c : (de([e], !0), c = e.style.display || c, d = x.css(e, "display"), de([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === x.css(e, "float") && (l || (p.done((function () {
                h.display = c
            })), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            }))), l = !1, f) l || (g ? "hidden" in g && (v = g.hidden) : g = G.access(e, "fxshow", {display: c}), r && (g.hidden = !v), v && de([e], !0), p.done((function () {
    ...
    x.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ((t = gt(e)).length) for (; n = this[l++];) if (o = vt(n), i = 1 === n.nodeType && " " + ht(o) + " ") {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each((function (n) {
                ...
                var t, o, r, s;
                if (i) for (o = 0, r = x(this), s = gt(e); t = s[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = vt(this)) && G.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : G.get(this, "__className__") || ""))
            }))
        }, hasClass: function (e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];) if (1 === n.nodeType && (" " + ht(vt(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var yt = /\r/g;
    ...
    var mt = /^(?:focusinfocus|focusoutblur)$/, wt = function (e) {
        e.stopPropagation()
    };
    x.extend(x.event, {
        trigger: function (t, n, i, o) {
            ...
            if (s = f = a = i = i || g, 3 !== i.nodeType && 8 !== i.nodeType && !mt.test(m + x.event.triggered) && (m.indexOf(".") > -1 && (w = m.split("."), m = w.shift(), w.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[x.expando] ? t : new x.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = w.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : x.makeArray(n, [t]), p = x.event.special[m] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                if (!o && !p.noBubble && !v(i)) {
                    for (l = p.delegateType || m, mt.test(l + m) || (s = s.parentNode); s; s = s.parentNode) y.push(s), a = s;
                    a === (i.ownerDocument || g) && y.push(a.defaultView || a.parentWindow || e)
                }
                for (r = 0; (s = y[r++]) && !t.isPropagationStopped();) f = s, t.type = r > 1 ? l : p.bindType || m, (u = (G.get(s, "events") || Object.create(null))[t.type] && G.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && Y(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = m, o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(y.pop(), n) || !Y(i) || c && h(i[m]) && !v(i) && ((a = i[c]) && (i[c] = null), x.event.triggered = m, t.isPropagationStopped() && f.addEventListener(m, wt), i[m](), t.isPropagationStopped() && f.removeEventListener(m, wt), x.event.triggered = void 0, a && (i[c] = a)), t.result
            }
    ...
    var bt = e.location, xt = {guid: Date.now()}, Tt = /\?/;
    ...
    function At(e, t, n, i) {
        ...
        })); else if (n || "object" !== w(t)) i(e, t); else for (o in t) At(e + "[" + o + "]", t[o], n, i)
    }
    ...
    x.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map((function () {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && $t.test(this.nodeName) && !Ct.test(e) && (this.checked || !fe.test(e))
            })).map((function (e, t) {
                var n = x(this).val();
    ...
    var Et = /%20/g, jt = /#.*$/, Dt = /([?&])_=[^&]*/, Nt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ht = /^(?:GET|HEAD)$/,
        Lt = /^\/\//, Ot = {}, Pt = {}, qt = "*/".concat("*"), Mt = g.createElement("a");
    ...
    Mt.href = bt.href, x.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, r, s, a, l, c, d, u, p, f = x.ajaxSetup({}, n), h = f.context || f,
                v = f.context && (h.nodeType || h.jquery) ? x(h) : x.event, y = x.Deferred(),
                m = x.Callbacks("once memory"), w = f.statusCode || {}, b = {}, T = {}, k = "canceled", S = {
            ...
            if (y.promise(S), f.url = ((t || f.url || bt.href) + "").replace(Lt, bt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(P) || [""], null == f.crossDomain) {
                l = g.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = x.param(f.data, f.traditional)), zt(Ot, f, n, S), c) return S;
            for (u in (d = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Ht.test(f.type), o = f.url.replace(jt, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Et, "+")) : (p = f.url.slice(o.length), f.data && (f.processData || "string" == typeof f.data) && (o += (Tt.test(o) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (o = o.replace(Dt, "$1"), p = (Tt.test(o) ? "&" : "?") + "_=" + xt.guid++ + p), f.url = o + p), f.ifModified && (x.lastModified[o] && S.setRequestHeader("If-Modified-Since", x.lastModified[o]), x.etag[o] && S.setRequestHeader("If-None-Match", x.etag[o])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && S.setRequestHeader("Content-Type", f.contentType), S.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : f.accepts["*"]), f.headers) S.setRequestHeader(u, f.headers[u]);
            if (f.beforeSend && (!1 === f.beforeSend.call(h, S, f) || c)) return S.abort();
            if (k = "abort", m.add(f.complete), S.done(f.success), S.fail(f.error), i = zt(Pt, f, n, S)) {
            ...
            function C(t, n, s, l) {
                var u, p, g, b, T, k = n;
                c || (c = !0, a && e.clearTimeout(a), i = void 0, r = l || "", S.readyState = t > 0 ? 4 : 0, u = t >= 200 && t < 300 || 304 === t, s && (b = function (e, t, n) {
    ...
    x.ajaxSetup({
        ...
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (f.createHTMLDocument ? ((i = (t = g.implementation.createHTMLDocument("")).createElement("base")).href = g.location.href, t.head.appendChild(i)) : t = g), r = !n && [], (o = E.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, r), r && r.length && x(r).remove(), x.merge([], o.childNodes)));
        var i, o, r
    }, x.fn.load = function (e, t, n) {
        var i, o, r, s = this, a = e.indexOf(" ");
        return a > -1 && (i = ht(e.slice(a)), e = e.slice(0, a)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && x.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            ...
            "static" === c && (e.style.position = "relative"), a = d.offset(), r = x.css(e, "top"), l = x.css(e, "left"), ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (s = (i = d.position()).top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), h(t) && (t = t.call(e, n, x.extend({}, a))), null != t.top && (u.top = t.top - a.top + s), null != t.left && (u.left = t.left - a.left + o), "using" in t ? t.using.call(e, u) : d.css(u)
        }
    }, x.fn.extend({
        offset: function (e) {
        ...
        x.cssHooks[t] = Fe(f.pixelPosition, (function (e, n) {
            if (n) return n = Re(e, t), Me.test(n) ? x(e).position()[t] + "px" : n
        }))
        ...
        x.each({padding: "inner" + e, content: t, "": "outer" + e}, (function (n, i) {
            x.fn[i] = function (o, r) {
                ...
                return F(this, (function (t, n, o) {
                    var r;
                    return v(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === o ? x.css(t, n, a) : x.style(t, n, o, a)
                }), t, s ? o : void 0, s)
            }
        }))
    ...
    }, x.isArray = Array.isArray, x.parseJSON = JSON.parse, x.nodeName = A, x.isFunction = h, x.isWindow = v, x.camelCase = X, x.type = w, x.now = Date.now, x.isNumeric = function (e) {
        var t = x.type(e);
    ...
    $("#defaultOpen").click(), $(".cards-side__title").on("click", (function () {
        let e = !1;
        $(this).hasClass("cards-side__title--active") && (e = !0), $(this).removeClass("cards-side__title--active"), e || $(this).addClass("cards-side__title--active")
    })), $(".cards-content__sort").on("click", (function () {
        $(".cards-content__hidden").hasClass("cards-content__hidden--active") ? $(".cards-content__hidden").removeClass("cards-content__hidden--active") : $(".cards-content__hidden").addClass("cards-content__hidden--active")
    })), $(".cards-content__hidden-link").on("click", (function () {
        $(".cards-content__hidden").removeClass("cards-content__hidden--active"), console.log(1)
    })), $(".cards-content__sort-text").on("click", (function () {
        $(this).toggleClass("transform")
    })), $("#slider-range").slider({
        range: !0, min: 43, max: 68, values: [43, 68], slide: function (e, t) {
            $("#amount1").text("€" + t.values[0] + "K"), $("#amount2").text("€" + t.values[1] + "K")
        }
